...
public class AuthService {
    ...
    public LoginResponseDto login(LoginSRequestDto loginRequestDto) {
    ...
    public ResponseEntity<LoginResponseDto> handleOAuth2LoginRequest(OAuth2User oAuth2User, String registrationId) {
        AuthProviderType providerType = authUtil.getAuthProviderTypeFromToken(registrationId);
        ...
        if (user == null && emailUser == null) {
            ...
            throw new BadCredentialsException("This email is already registered with provider type: " +
        ...
        // save the providertype and providerid with user
        // if user has a account : login
